...
/proc/readglobal(which)
	switch(which)
		...
		if("Dclothing")
			return global.Dclothing;
		if("Debug")
			return global.Debug;
		if("Debug2")
			return global.Debug2;
		if("Dtools")
			return global.Dtools;
		if("Dtoys")
			return global.Dtoys;
		if("Dtrash")
			return global.Dtrash;
		if("Failsafe")
		...
		if("all_integrated_circuits")
			return global.all_integrated_circuits;
		if("all_languages")
		...
		if("all_objectives_types")
			return global.all_objectives_types;
		if("all_socks")
			return global.all_socks;
		if("all_solved_wires")
		...
		if("all_undershirts")
			return global.all_undershirts;
		if("all_underwears")
			return global.all_underwears;
		...
		if("body_modifications")
			return global.body_modifications;
		if("bomb_set")
		...
		if("broken_bottle_icon_cache")
			return global.broken_bottle_icon_cache;
		if("cable_list")
		...
		if("chameleons_categories")
			return global.chameleons_categories;
		if("changelog_hash")
		...
		if("engineering_networks")
			return global.engineering_networks;
		...
		if("explosions_log")
			return global.explosions_log;
		if("facial_hair_styles_by_species")
			return global.facial_hair_styles_by_species;
		...
		if("hair_styles_by_species")
			return global.hair_styles_by_species;
		if("hair_styles_list")
			return global.hair_styles_list;
		if("hazard_overlays")
			return global.hazard_overlays;
		if("hearing_objects")
			return global.hearing_objects;
		if("heartstopper")
		...
		if("holodeck_programs")
			return global.holodeck_programs;
		...
		if("human_emotes_list")
			return global.human_emotes_list;
		if("human_icon_cache")
			return global.human_icon_cache;
		if("human_mob_list")
			return global.human_mob_list;
		if("icarus_position")
			return global.icarus_position;
		...
		if("modifications_types")
			return global.modifications_types;
		if("motion_alarm")
		...
		if("musical_all_environments")
			return global.musical_all_environments;
		if("musical_free_channels")
			return global.musical_free_channels;
		if("musical_free_channels_populated")
			return global.musical_free_channels_populated;
		if("musical_n2t_int")
			return global.musical_n2t_int;
		if("musical_nn2no")
			return global.musical_nn2no;
		if("name_to_material")
		...
		if("redcode_robot_modules")
			return global.redcode_robot_modules;
		if("reg_dna")
		...
		if("robot_emotes_list")
			return global.robot_emotes_list;
		...
		if("station_networks")
			return global.station_networks;
		if("stool_cache")
...
/proc/writeglobal(which, newval)
	switch(which)
		...
		if("Dclothing")
			global.Dclothing=newval;
		if("Debug")
			global.Debug=newval;
		if("Debug2")
			global.Debug2=newval;
		if("Dtools")
			global.Dtools=newval;
		if("Dtoys")
			global.Dtoys=newval;
		if("Dtrash")
			global.Dtrash=newval;
		if("Failsafe")
		...
		if("all_integrated_circuits")
			global.all_integrated_circuits=newval;
		if("all_languages")
		...
		if("all_objectives_types")
			global.all_objectives_types=newval;
		if("all_socks")
			global.all_socks=newval;
		if("all_solved_wires")
		...
		if("all_undershirts")
			global.all_undershirts=newval;
		if("all_underwears")
			global.all_underwears=newval;
		if("all_unit_tests_passed")
		...
		if("body_modifications")
			global.body_modifications=newval;
		if("bomb_set")
		...
		if("broken_bottle_icon_cache")
			global.broken_bottle_icon_cache=newval;
		if("cable_list")
		...
		if("chameleons_categories")
			global.chameleons_categories=newval;
		if("changelog_hash")
		...
		if("engineering_networks")
			global.engineering_networks=newval;
		if("engineering_positions")
		...
		if("explosions_log")
			global.explosions_log=newval;
		if("facial_hair_styles_by_species")
			global.facial_hair_styles_by_species=newval;
		if("facial_hair_styles_list")
		...
		if("hair_styles_by_species")
			global.hair_styles_by_species=newval;
		if("hair_styles_list")
			global.hair_styles_list=newval;
		if("hazard_overlays")
			global.hazard_overlays=newval;
		if("hearing_objects")
			global.hearing_objects=newval;
		if("heartstopper")
		...
		if("holodeck_programs")
			global.holodeck_programs=newval;
		if("home_system_choices")
		...
		if("human_emotes_list")
			global.human_emotes_list=newval;
		if("human_icon_cache")
			global.human_icon_cache=newval;
		if("human_mob_list")
			global.human_mob_list=newval;
		if("icarus_position")
			global.icarus_position=newval;
		if("icons_to_ignore_at_floor_init")
		...
		if("modifications_types")
			global.modifications_types=newval;
		if("motion_alarm")
		...
		if("musical_all_environments")
			global.musical_all_environments=newval;
		if("musical_free_channels")
			global.musical_free_channels=newval;
		if("musical_free_channels_populated")
			global.musical_free_channels_populated=newval;
		if("musical_n2t_int")
			global.musical_n2t_int=newval;
		if("musical_nn2no")
			global.musical_nn2no=newval;
		if("name_to_material")
		...
		if("redcode_robot_modules")
			global.redcode_robot_modules=newval;
		if("reg_dna")
		...
		if("robot_emotes_list")
			global.robot_emotes_list=newval;
		if("robot_hud_colours")
		...
		if("station_networks")
			global.station_networks=newval;
		if("stool_cache")
...
/var/list/_all_globals=list(
	...
	"motion_alarm",
	"movement_disabled",
	"movement_disabled_exception",
	"moving_levels",
	"musical_all_environments",
	"musical_free_channels",
	"musical_free_channels_populated",
	"musical_n2t_int",
	"musical_nn2no",
	"name_to_material",
	"nanomanager",
	...
	"powers",
	"preferences_datums",
	"prevent_airgroup_regroup",
	"priority_air_alarms",
	"priority_announcement",
	"prison_shuttle_at_station",
	"prison_shuttle_can_send",
	"prison_shuttle_moving_to_prison",
	"prison_shuttle_moving_to_station",
	"prison_shuttle_time",
	"prison_shuttle_timeleft",
	"prisonsecuritywarp",
	"prisonwarp",
	"prisonwarped",
	"processScheduler",
