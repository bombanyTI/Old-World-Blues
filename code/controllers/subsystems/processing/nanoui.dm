...
/datum/controller/subsystem/processing/nanoui/proc/get_open_ui(mob/user, src_object, ui_key)
	...
	//testing("SSnanoui/get_open_ui mob [user.name] [src_object:name] [ui_key] - ui not found")
	return null
...
/datum/controller/subsystem/processing/nanoui/proc/close_user_uis(mob/user, src_object, ui_key)
	...
	//testing("SSnanoui/close_user_uis mob [user.name] closed [open_uis.len] of [.] uis")
...
/datum/controller/subsystem/processing/nanoui/proc/ui_opened(datum/nanoui/ui)
	...
	//testing("SSnanoui/ui_opened mob [ui.user.name] [ui.src_object:name] [ui.ui_key] - user.open_uis [ui.user.open_uis.len] | uis [uis.len] | processing_uis [processing_uis.len]")
...
/datum/controller/subsystem/processing/nanoui/proc/ui_closed(datum/nanoui/ui)
	...
	//testing("SSnanoui/ui_closed mob [ui.user.name] [ui.src_object:name] [ui.ui_key] - user.open_uis [ui.user.open_uis.len] | uis [uis.len] | processing_uis [processing_uis.len]")
...
/datum/controller/subsystem/processing/nanoui/proc/user_transferred(mob/oldMob, mob/newMob)
	//testing("SSnanoui/user_transferred from mob [oldMob.name] to mob [newMob.name]")
	if (!oldMob || !LAZYLEN(oldMob.open_uis) || !LAZYLEN(open_uis))
		//testing("SSnanoui/user_transferred mob [oldMob.name] has no open uis")
		return 0 // has no open uis
...
/datum/controller/subsystem/processing/nanoui/proc/send_resources(client)
